...
public class AppIntro {
    ...
    public AppIntro(MainActivity ctx, int language) {
        ...
        if (m_ctx.getCurLayout() == MainActivity.LAYOUT_ABOUT) {
            m_strStart = res.getString(res.getIdentifier("str_back", "string", strPackage));
        } else if (m_ctx.getCurLayout() == MainActivity.LAYOUT_INTRO) {
    ...
    public Bitmap loadBitmap(String fileName) {
        ...
        try {
            ...
            Log.d("DCT", "Error read bitmap");
        }
        return bmp;
    }

    public void onOrientation(int ori) {
        Log.d("DCT", "New orientation");
        m_oriChanged = 1;
    }
    ...
    public boolean onTouch(int x, int y, int touchType) {
        ...
        int stateNext;
        //if (MainActivity.APP_RUN_MODE)
        //	stateNext = MainActivity.VIEW_PLAY;
        //else
        //stateNext = MainActivity.VIEW_MENU;
        ...
        if (rDst.contains(x, y)) {
            ...
            m_ctx.setContentView(R.layout.menu_layout);
            m_ctx.setCurLayout(m_ctx.LAYOUT_MENU);
            return false;
        }
